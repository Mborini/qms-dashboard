...
export default function StatsPage() {
  ...
  async function getData() {
    try {
      ...
      const range = getDateRange(dateFrom);

      params.append("dateFrom", range.from);
      ...
      if (!response.ok) {
        let message = "تعذر تحميل بيانات الإحصائيات";
...
================================================= */}
    ...
    ================================================= */}
            ...
            <Button
              ...
              style={{
                ...
                padding: "0 20px",
                flexShrink: 0,
                boxShadow: "0 6px 18px rgba(34,139,230,0.20)",
              }}
            >
              استعلام
            </Button>
    ...
    ================================================= */}
            ...
            >
              <Switch
                size="sm"
                label={showCollapsible ? "العرض التفصيلي" : "العرض المختصر"}
                checked={showCollapsible}
                onChange={(event) =>
                  setShowCollapsible(event.currentTarget.checked)
                }
              />
            </Box>
          </div>
        ...
        {error && !loading && (
          <Box
            ...
            style={{
              ...
              boxShadow: "0 10px 30px rgba(220,38,38,0.07)",
            }}
          >
            <Group
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text className="error-message" size="xs" c="dimmed" mt={2}>
                    {error}
                  </Text>
                </Box>
              </Group>
        ...
        {loading ? (
          <Box
            ...
            style={{
              ...
              boxShadow: "0 15px 45px rgba(31,41,55,0.06)",
            }}
          >
          ...
          >
            <Stack align="center" gap="xs">
              <IconChartBarOff size={42} stroke={1.4} color="#adb5bd" />
          ...
          >
            {showCollapsible ? (
              <FailureStatsCollapsible items={items} />
            ) : (
              <FailureStats items={items} />
            )}
          </Box>
        )}
      </Container>
  ...
  =================================================== */
        ...
        .search-button {
          ...
          box-shadow: 0 6px 18px rgba(34, 139, 230, 0.2);
        }
